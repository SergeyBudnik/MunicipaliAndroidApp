...
//    @Click(R.id.sign_up_with_google_button)
//    void onSignUpWithGoogleButton() {
//        redirectForResult(RegistrationGooglePlusActivity_.class, 0, 0, LOGIN_TO_GOOGLE_PLUS_REQUEST);
//    }

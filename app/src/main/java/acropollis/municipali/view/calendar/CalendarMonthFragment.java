...
public class CalendarMonthFragment extends RelativeLayout {
    ...
    private EventCalendarViewPagerAdapter adapter;
    ...
    public CalendarMonthFragment(Context context) {
        super(context);
    }

    public CalendarMonthFragment(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public void init(
            Context context,
            EventCalendarViewPagerAdapter adapter,
            int month,
            int year,
